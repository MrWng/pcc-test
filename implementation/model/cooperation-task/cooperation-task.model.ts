...
export const DYNAMIC_CUSTOM_TASK_PROJECT_CENTER_CONSOLE_COOPERATION_TASK = 'completeCoordinationPlanArrange-task-detail-waitting';
export const DYNAMIC_CUSTOM_TASK_PROJECT_CENTER_CONSOLE_COOPERATION_TASK_DTD = 'completeCoordinationPlanArrange_DTD-task-detail-waitting';

export class DynamicCooperationTaskModel extends DynamicFormValueControlModel<any> {
