...
export const DYNAMIC_CUSTOM_TASK_PROJECT_CENTER_CONSOLE_PROJECT_CHANGE_TASK = 'PCC_task_0003-task-detail-waitting';
export const DYNAMIC_CUSTOM_TASK_PROJECT_CENTER_CONSOLE_PROJECT_CHANGE_TASK_DTD = 'PCC_task_0003-task-detail-waitting';

export class DynamicProjectChangeTaskModel extends DynamicFormValueControlModel<any> {
