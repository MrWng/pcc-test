...
export const DYNAMIC_CUSTOM_SHOW_PCC_PROJECT_PROCESS = 'showPCCProjectProcess';

export class DynamicViewProjectProgressModel extends DynamicFormValueControlModel<any> {
  @serializable() readonly type: string = DYNAMIC_CUSTOM_SHOW_PCC_PROJECT_PROCESS;
