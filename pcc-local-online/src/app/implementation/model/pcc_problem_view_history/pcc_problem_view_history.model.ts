...
export const DYNAMIC_CUSTOM__ATHENA_PCC_PROBLEM_VIEW_HISTORY = 'pcc_problem_view_history';

export class DynamicPccProblemViewHistoryModel extends DynamicFormValueControlModel<any> {
  @serializable() readonly type: string = DYNAMIC_CUSTOM__ATHENA_PCC_PROBLEM_VIEW_HISTORY;
