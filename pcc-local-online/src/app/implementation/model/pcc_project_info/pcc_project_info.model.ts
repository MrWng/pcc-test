...
export const DYNAMIC_CUSTOM__ATHENA_PCC_PROJECT_INFO = 'showProjectInfo';

export class DynamicPccProjectInfoModel extends DynamicFormValueControlModel<any> {
  @serializable() readonly type: string = DYNAMIC_CUSTOM__ATHENA_PCC_PROJECT_INFO;
