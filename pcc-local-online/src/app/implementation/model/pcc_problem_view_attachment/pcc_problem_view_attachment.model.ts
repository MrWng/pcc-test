...
export const DYNAMIC_CUSTOM__ATHENA_PCC_PROBLEM_VIEW_ATTACHMENT = 'pcc_problem_view_attachment';

export class DynamicPccProblemViewAttachmentModel extends DynamicFormValueControlModel<any> {
  @serializable() readonly type: string = DYNAMIC_CUSTOM__ATHENA_PCC_PROBLEM_VIEW_ATTACHMENT;
