...
export class TableDetailComponent implements OnInit {
  ...
  formatTableData(list) {
    const status = {
      key_1: this.translateService.instant('dj-default-未生产'),
      key_2: this.translateService.instant('dj-default-已发料'),
      key_3: this.translateService.instant('dj-default-生产中'),
      key_Y: this.translateService.instant('dj-default-已完工'),
      key_y: this.translateService.instant('dj-default-指定完工'),
      key_N: this.translateService.instant('dj-default-未完工'),
      key_F: this.translateService.instant('dj-default-已发出'),
      key_W: this.translateService.instant('dj-default-送签中'),
      key_M: this.translateService.instant('dj-default-成本结案'),
    };
    const op_type = {
      key_1: this.translateService.instant('dj-default-厂内制程'),
      key_2: this.translateService.instant('dj-default-托外制程'),
      key_3: this.translateService.instant('dj-default-二者皆有'),
    };
    list.forEach((o) => {
      o.status = status[`key_${o.status}`] || o.status;
