  ...
  getRules(): any[] {
    return [
      ...
      },
      {
        ...
        condition: 'true',
        scope: 'EDIT',
        errorMessage: this.translateService.instant('dj-pcc-工时不允许为空！'),
        key: 'required',
      },
      {
        schema: 'work_hours',
        ...
        validatorType: 'error',
        linkageSchemas: [],
        errorMessage: this.translateService.instant(`dj-pcc-工时不允许为0！`),
        trigger: {
          condition: 'data.work_hours === 0',
        },
        key: 'custom',
      },
      {
        ...
        path: 'manualWorkReporting',
        scope: 'EDIT',
        linkageSchemas: ['employee_no', 'department_name', 'department_no'],
        errorMessage: this.translateService.instant(`dj-pcc-不能同时录入相同的执行人！`),
        trigger: {
          point: 'dataChanged',
          condition: 'true',
        },
