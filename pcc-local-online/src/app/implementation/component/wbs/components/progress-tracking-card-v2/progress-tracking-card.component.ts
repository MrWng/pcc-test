...
import { WbsCardComponent } from '../wbs-card/wbs-card.component';

@Component({
  selector: 'app-progress-tracking-card-v2',
  templateUrl: './progress-tracking-card.component.html',
  styleUrls: ['./progress-tracking-card.component.less'],
})
export class ProgressTrackingCardV2Component implements OnInit, OnChanges, AfterViewInit {
   ...
   * @param item 展开/收起子节点
   */
  showOrHideChildren(item: any, e: any, cardInstance: WbsCardComponent) {
    e.stopPropagation();
